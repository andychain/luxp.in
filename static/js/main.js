...
/* ──────────────────────────────────────
   TICKER DATA
   Edit scrolling ticker items here.
   ────────────────────────────────────── */
const tickerItems = [
  { n: 'Jackpot City',  p: '+2.1%', up: true  },
  { n: '888 Casino',    p: '-0.8%', up: false  },
  { n: 'LeoVegas',      p: '+4.2%', up: true   },
  { n: 'Spin Casino',   p: '+1.5%', up: true   },
  { n: 'Royal Vegas',   p: '-1.2%', up: false  },
  { n: 'Casumo',        p: '-0.3%', up: false  },
  { n: 'Betway Casino', p: '+2.9%', up: true   },
  { n: 'PlayOJO',       p: '-0.6%', up: false  },
];
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Render ticker
  document.getElementById('ticker').innerHTML = [...tickerItems, ...tickerItems].map(t =>
